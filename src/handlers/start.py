...
async def help_handler(message: Message, user_data: UserCacheItem | None) -> None:
    ...
    help_text = (
        ...
        "Цей бот допомагає автоматично шукати вакансії (в основному на ресурсах пов'язаних з IT) "
        "за твоїми кастомними фільтрами та аналізувати їх за допомогою ШІ.\n\n"
        "⚙️ <b>Як це працює:</b>\n"
        "1. Раз на добу бот збирає нові вакансії з ринку.\n"
        "2. Проганяє їх через твої налаштування (ключові слова, AI-промпт, файл CV).\n"
